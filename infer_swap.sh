...
export OUTPUT_DIR="results/swap/"
export DATASET_LOADING_SCRIPT_PATH="my_dataset/my_dataset_swap.py"
...
accelerate launch --main_process_port=29500 --multi_gpu -m examples.referencenet.infer_referencenet \
	...
	--anonymization_degree_start "0.0" \
	--anonymization_degree_end "0.0" \
